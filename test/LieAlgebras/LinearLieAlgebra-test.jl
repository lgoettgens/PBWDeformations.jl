@testset ExtendedTestSet "All LinearLieAlgebra.jl tests" begin
    ...
    @testset "conformance tests for $desc" for (desc, L, parentT, elemT) in [
        ("sl_4(QQ)", special_linear_lie_algebra(QQ, 4), LinearLieAlgebra{fmpq}, LinearLieAlgebraElem{fmpq}),
        ("so_4(QQ)", special_orthogonal_lie_algebra(QQ, 4), LinearLieAlgebra{fmpq}, LinearLieAlgebraElem{fmpq}),
        (
            "sl_4(CF(4))",
    ...
    @testset "so_n correctness regression" begin
        ...
        function lie_algebra_module_struct_const(L::LieAlgebra{C}, V::LieAlgebraModule{C}) where {C <: RingElement}
            R = base_ring(L)
            dimL = dim(L)
            dimV = dim(V)
        ...
        @test repr("text/plain", lie_algebra_module_struct_const(L, symmetric_power(standard_module(L), 1))) ==
              "3×3 Matrix{Vector{Tuple{QQFieldElem, Int64}}}:\n [(-1, 2)]  [(1, 1)]   []\n [(-1, 3)]  []         [(1, 1)]\n []         [(-1, 3)]  [(1, 2)]"
        @test repr("text/plain", lie_algebra_module_struct_const(L, symmetric_power(standard_module(L), 2))) ==
              "3×6 Matrix{Vector{Tuple{QQFieldElem, Int64}}}:\n [(-2, 2)]  [(1, 1), (-1, 4)]  [(-1, 5)]          [(2, 2)]   [(1, 3)]           []\n [(-2, 3)]  [(-1, 5)]          [(1, 1), (-1, 6)]  []         [(1, 2)]           [(2, 3)]\n []         [(-1, 3)]          [(1, 2)]           [(-2, 5)]  [(1, 4), (-1, 6)]  [(2, 5)]"
        @test repr("text/plain", lie_algebra_module_struct_const(L, symmetric_power(standard_module(L), 3))) ==
        ...
        @test repr("text/plain", lie_algebra_module_struct_const(L, exterior_power(standard_module(L), 1))) ==
              "3×3 Matrix{Vector{Tuple{QQFieldElem, Int64}}}:\n [(-1, 2)]  [(1, 1)]   []\n [(-1, 3)]  []         [(1, 1)]\n []         [(-1, 3)]  [(1, 2)]"
        @test repr("text/plain", lie_algebra_module_struct_const(L, exterior_power(standard_module(L), 2))) ==
              "3×3 Matrix{Vector{Tuple{QQFieldElem, Int64}}}:\n []         [(-1, 3)]  [(1, 2)]\n [(1, 3)]   []         [(-1, 1)]\n [(-1, 2)]  [(1, 1)]   []"
        ...
        @test repr("text/plain", lie_algebra_module_struct_const(L, exterior_power(standard_module(L), 2))) ==
              "6×6 Matrix{Vector{Tuple{QQFieldElem, Int64}}}:\n []         [(-1, 4)]  [(-1, 5)]  [(1, 2)]   [(1, 3)]   []\n [(1, 4)]   []         [(-1, 6)]  [(-1, 1)]  []         [(1, 3)]\n [(1, 5)]   [(1, 6)]   []         []         [(-1, 1)]  [(-1, 2)]\n [(-1, 2)]  [(1, 1)]   []         []         [(-1, 6)]  [(1, 5)]\n [(-1, 3)]  []         [(1, 1)]   [(1, 6)]   []         [(-1, 4)]\n []         [(-1, 3)]  [(1, 2)]   [(-1, 5)]  [(1, 4)]   []"
        @test repr("text/plain", lie_algebra_module_struct_const(L, exterior_power(standard_module(L), 3))) ==
              "6×4 Matrix{Vector{Tuple{QQFieldElem, Int64}}}:\n []         []         [(-1, 4)]  [(1, 3)]\n []         [(1, 4)]   []         [(-1, 2)]\n [(-1, 4)]  []         []         [(1, 1)]\n []         [(-1, 3)]  [(1, 2)]   []\n [(1, 3)]   []         [(-1, 1)]  []\n [(-1, 2)]  [(1, 1)]   []         []"
